        ...
        <Row>
            <Col>
                        ...
                        <div className='skill-bx'>
                            ...
                            <p>{props.language ? 'Aqui algunas de las habilidades con la que me siento comfortable trabajando.':'These are a list of the skills I feel more comfortable with'}.</p>
                            <TrackVisibility> 
                                     {({isVisible})=>
                                        <div className={ isVisible ? 'skillsCardContent animate__animated animate__slideInLeft': "skillnotShowing"}>
                                            <Card style={{ width: '18rem' }} className='skillsCard'>
                                                <Card.Body>
                                                    ...
                                                    <Card.Text className='frontendski'>
                                                        {props.language ? "Las diferentes herramientas que eh utilizado para desarollar el frontend en proyectos en los que eh trabajado:" :  "These are  some of the tools I use to develop the frontend in the projects I've worked on:"}
                                                    </Card.Text>
                                            ...
                                            <Card style={{ width: '18rem' }} className='skillsCard'>
                                                <Card.Body>
                                                    ...
                                                    <Card.Text className='frontendski'>
                                                    {props.language ? "Las diferentes herramientas que eh utilizado para desarollar el backend en proyectos en los que eh trabajado:" :  "These are  some of the tools I use to develop the backend in the projects I've worked on:"}
                                                    </Card.Text>
